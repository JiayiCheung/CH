...
class ComplexityAnalyzer:
	...
	def compute_complexity(self, label_data):
		...
		try:
			...
			logger.warning(f"Error computing skeleton: {e}")
			branch_ratio = 0
		...
		try:
			...
			logger.warning(f"Error computing boundary: {e}")
			boundary_ratio = 0
		...
		try:
			...
			logger.warning(f"Error computing components: {e}")
		...
		try:
			...
			logger.warning(f"Error computing Euler number: {e}")
			euler_complexity = 0
		...
		logger.debug(f"Complexity: {normalized:.3f} (fg={foreground_ratio:.3f}, "
	...
	def adjust_sampling_density(self, complexity, base_tier1, base_tier2):
		...
		logger.debug(f"Adjusted sampling: tier1={tier1_samples}, tier2={tier2_samples} "
